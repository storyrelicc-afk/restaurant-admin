...
const TRANSLATE_DICT = {
  ...
  "salata":{en:"salad",ja:"サラダ",zh:"沙拉",ru:"салат",de:"Salat",ko:"샐러드"},
  "çorba":{en:"soup",ja:"スープ",zh:"汤",ru:"суп",de:"Suppe",ko:"수프"},
  "tavuk":{en:"chicken",ja:"チキン",zh:"鸡肉",ru:"курица",de:"Hühnchen",ko:"치킨"},
  "balık":{en:"fish",ja:"魚",zh:"鱼",ru:"рыба",de:"Fisch",ko:"생선"},
  "et":{en:"meat",ja:"肉",zh:"肉",ru:"мясо",de:"Fleisch",ko:"고기"},
  "biftek":{en:"steak",ja:"ステーキ",zh:"牛排",ru:"стейк",de:"Steak",ko:"스테이크"},
  "kuzu":{en:"lamb",ja:"ラム",zh:"羊肉",ru:"баранина",de:"Lamm",ko:"양고기"},
  "dana":{en:"beef",ja:"ビーフ",zh:"牛肉",ru:"говядина",de:"Rindfleisch",ko:"소고기"},
  "karides":{en:"shrimp",ja:"エビ",zh:"虾",ru:"креветка",de:"Garnele",ko:"새우"},
  "mantar":{en:"mushroom",ja:"キノコ",zh:"蘑菇",ru:"грибы",de:"Pilz",ko:"버섯"},
  "pirinç":{en:"rice",ja:"米",zh:"米饭",ru:"рис",de:"Reis",ko:"쌀"},
  "patates":{en:"potato",ja:"ポテト",zh:"土豆",ru:"картофель",de:"Kartoffel",ko:"감자"},
  "domates":{en:"tomato",ja:"トマト",zh:"番茄",ru:"помидор",de:"Tomate",ko:"토마토"},
  "soğan":{en:"onion",ja:"オニオン",zh:"洋葱",ru:"лук",de:"Zwiebel",ko:"양파"},
  "sarımsak":{en:"garlic",ja:"ガーリック",zh:"大蒜",ru:"чеснок",de:"Knoblauch",ko:"마늘"},
  "biber":{en:"pepper",ja:"ピーマン",zh:"辣椒",ru:"перец",de:"Paprika",ko:"고추"},
  "limon":{en:"lemon",ja:"レモン",zh:"柠檬",ru:"лимон",de:"Zitrone",ko:"레몬"},
  "zeytin":{en:"olive",ja:"オリーブ",zh:"橄榄",ru:"оливки",de:"Olive",ko:"올리브"},
  "peynir":{en:"cheese",ja:"チーズ",zh:"芝士",ru:"сыр",de:"Käse",ko:"치즈"},
  "yumurta":{en:"egg",ja:"卵",zh:"鸡蛋",ru:"яйцо",de:"Ei",ko:"계란"},
  "ekmek":{en:"bread",ja:"パン",zh:"面包",ru:"хлеб",de:"Brot",ko:"빵"},
  "çikolata":{en:"chocolate",ja:"チョコレート",zh:"巧克力",ru:"шоколад",de:"Schokolade",ko:"초콜릿"},
  "dondurma":{en:"ice cream",ja:"アイスクリーム",zh:"冰淇淋",ru:"мороженое",de:"Eis",ko:"아이스크림"},
  "kahve":{en:"coffee",ja:"コーヒー",zh:"咖啡",ru:"кофе",de:"Kaffee",ko:"커피"},
  "çay":{en:"tea",ja:"お茶",zh:"茶",ru:"чай",de:"Tee",ko:"차"},
  "şarap":{en:"wine",ja:"ワイン",zh:"葡萄酒",ru:"вино",de:"Wein",ko:"와인"},
  "bira":{en:"beer",ja:"ビール",zh:"啤酒",ru:"пиво",de:"Bier",ko:"맥주"},
  "su":{en:"water",ja:"水",zh:"水",ru:"вода",de:"Wasser",ko:"물"},
  "tatlı":{en:"dessert",ja:"デザート",zh:"甜点",ru:"десерт",de:"Dessert",ko:"디저트"},
  "başlangıç":{en:"starter",ja:"前菜",zh:"开胃菜",ru:"закуска",de:"Vorspeise",ko:"애피타이저"},
  "ana yemek":{en:"main course",ja:"メイン料理",zh:"主菜",ru:"основное блюдо",de:"Hauptgericht",ko:"메인 요리"},
  "içecek":{en:"drink",ja:"飲み物",zh:"饮品",ru:"напиток",de:"Getränk",ko:"음료"},
  "ızgara":{en:"grilled",ja:"グリル",zh:"烤",ru:"гриль",de:"gegrillt",ko:"그릴"},
  "fırın":{en:"oven-baked",ja:"オーブン焼き",zh:"烤箱烤制",ru:"запечённый",de:"gebacken",ko:"오븐에 구운"},
  "taze":{en:"fresh",ja:"新鮮な",zh:"新鲜",ru:"свежий",de:"frisch",ko:"신선한"},
  "özel":{en:"special",ja:"特別な",zh:"特色",ru:"特殊",de:"besonders",ko:"특별한"},
  "geleneksel":{en:"traditional",ja:"伝統的な",zh:"传统",ru:"традиционный",de:"traditionell",ko:"전통적인"},
  "ev yapımı":{en:"homemade",ja:"自家製",zh:"自制",ru:"домашний",de:"hausgemacht",ko:"수제"},
  "mevsim":{en:"seasonal",ja:"季節の",zh:"季节性",ru:"сезонный",de:"saisonal",ko:"계절"},
  "sos":{en:"sauce",ja:"ソース",zh:"酱汁",ru:"соус",de:"Sauce",ko:"소스"},
  "garnitür":{en:"garnish",ja:"付け合わせ",zh:"配菜",ru:"гарнир",de:"Garnitur",ko:"가니쉬"},
  // ── Genel ifadeler / kategori isimleri ──────────────────────
  "başlangıçlar":{en:"Starters",ja:"前菜",zh:"开胃菜",ru:"Закуски",de:"Vorspeisen",ko:"애피타이저"},
  "ana yemekler":{en:"Main Courses",ja:"メイン料理",zh:"主菜",ru:"Основные блюда",de:"Hauptgerichte",ko:"메인 요리"},
  "izgaralar":{en:"Grills",ja:"グリル",zh:"烤类",ru:"Гриль",de:"Grillgerichte",ko:"그릴 요리"},
  "tatlılar":{en:"Desserts",ja:"デザート",zh:"甜点",ru:"Десерты",de:"Desserts",ko:"디저트"},
  "içecekler":{en:"Drinks",ja:"飲み物",zh:"饮品",ru:"Напитки",de:"Getränke",ko:"음료"},
  "salatalar":{en:"Salads",ja:"サラダ",zh:"沙拉",ru:"Салаты",de:"Salate",ko:"샐러드"},
  "çorbalar":{en:"Soups",ja:"スープ",zh:"汤类",ru:"Супы",de:"Suppen",ko:"수프"},
  "deniz ürünleri":{en:"Seafood",ja:"シーフード",zh:"海鲜",ru:"Морепродукты",de:"Meeresfrüchte",ko:"해산물"},
  "vejeteryan":{en:"Vegetarian",ja:"ベジタリアン",zh:"素食",ru:"Вегетарианское",de:"Vegetarisch",ko:"채식"},
  "kebaplar":{en:"Kebabs",ja:"ケバブ",zh:"烤肉串",ru:"Кебабы",de:"Kebabs",ko:"케밥"},
  "pizzalar":{en:"Pizzas",ja:"ピザ",zh:"披萨",ru:"Пиццы",de:"Pizzen",ko:"피자"},
  "makarnalar":{en:"Pastas",ja:"パスタ",zh:"意面",ru:"Паста",de:"Pasta",ko:"파스타"},
  "mezeler":{en:"Mezze",ja:"メゼ",zh:"开胃小菜",ru:"Мезе",de:"Mezze",ko:"메제"},
  "suşiler":{en:"Sushi",ja:"寿司",zh:"寿司",ru:"Суши",de:"Sushi",ko:"초밥"},
  "noodle":{en:"Noodles",ja:"麺類",zh:"面条",ru:"Лапша",de:"Nudeln",ko:"면류"},
  "dim sum":{en:"Dim Sum",ja:"点心",zh:"点心",ru:"Дим-сам",de:"Dim Sum",ko:"딤섬"},
};
...
function translateText(text, lang) {
  ...
  if (!changed) {
    const langLabels = {en:'[EN] ', ja:'[JA] ', zh:'[ZH] ', ru:'[RU] ', de:'[DE] ', ko:'[KO] '};
...
function getDefaultDB() {
  return {
    settings: {
      ...
      defaultLanguage:  "tr",
      hoursML: [
        {day:{tr:"Pazartesi – Perşembe",en:"Monday – Thursday",ja:"月曜日–木曜日",zh:"周一至周四",ru:"Понедельник – Четверг",de:"Montag – Donnerstag",ko:"월요일–목요일"}, time:"12:00 – 23:00"},
        {day:{tr:"Cuma – Cumartesi",en:"Friday – Saturday",ja:"金曜日–土曜日",zh:"周五至周六",ru:"Пятница – Субота",de:"Freitag – Samstag",ko:"금요일–토요일"}, time:"12:00 – 00:30"},
        {day:{tr:"Pazar",en:"Sunday",ja:"日曜日",zh:"周日",ru:"Воскресенье",de:"Sonntag",ko:"일요일"}, time:"12:00 – 22:00"}
      ],
      statsML: [
        {num:"10+", label:{tr:"Yıllık Deneyim",en:"Years of Experience",ja:"年の経験",zh:"年经验",ru:"Лет опыта",de:"Jahre Erfahrung",ko:"년의 경험"}},
        {num:"50k", label:{tr:"Mutlu Misafir",en:"Happy Guests",ja:"満足したお客様",zh:"满意客户",ru:"Довольных гостей",de:"Zufriedene Gäste",ko:"만족한 고객"}},
        {num:"4.9", label:{tr:"Ortalama Puan",en:"Average Rating",ja:"平均評価",zh:"平均评分",ru:"Средний рейтинг",de:"Durchschnittsbewertung",ko:"평균 평점"}},
        {num:"3",   label:{tr:"Ödül",en:"Awards",ja:"受賞",zh:"奖项",ru:"Награды",de:"Auszeichnungen",ko:"수상"}}
      ],
    ...
    menuCategories: [
      {id:1, name:{tr:"Başlangıçlar",en:"Starters",ja:"前菜",zh:"开胃菜",ru:"Закуски",de:"Vorspeisen",ko:"애피타이저"}, slug:"starters", icon:"🥗", active:true, order:1},
      {id:2, name:{tr:"Ana Yemekler",en:"Main Courses",ja:"メイン料理",zh:"主菜",ru:"Основные блюда",de:"Hauptgerichte",ko:"메인 요리"}, slug:"mains", icon:"🍽️", active:true, order:2},
      {id:3, name:{tr:"Izgaralar",en:"Grills",ja:"グリル",zh:"烤类",ru:"Гриль",de:"Grillgerichte",ko:"그릴 요리"}, slug:"grills", icon:"🔥", active:true, order:3},
      {id:4, name:{tr:"Tatlılar",en:"Desserts",ja:"デザート",zh:"甜点",ru:"Десерты",de:"Desserts",ko:"디저트"}, slug:"desserts", icon:"🍮", active:true, order:4},
      {id:5, name:{tr:"İçecekler",en:"Drinks",ja:"飲み物",zh:"饮品",ru:"Напитки",de:"Getränke",ko:"음료"}, slug:"drinks", icon:"🍷", active:true, order:5}
    ],
    menuItems: [
      {id:1, name:{tr:"Mevsim Salatası",en:"Seasonal Salad",ja:"季節のサラダ",zh:"季节沙拉",ru:"Сезонный салат",de:"Saisonsalat",ko:"계절 샐러드"}, desc:{tr:"Taze mevsim yeşillikleri, kiraz domates, zeytin, balsamik sos",en:"Fresh seasonal greens, cherry tomatoes, olives, balsamic dressing",ja:"新鮮な季節の野菜、チェリートマト、オリーブ、バルサミコソース",zh:"新鲜时蔬，樱桃番茄，橄榄，意大利香醋",ru:"Свежая сезонная зелень, помидоры черри, оливки, бальзамическая заправка",de:"Frisches Saisongemüse, Kirschtomaten, Oliven, Balsamico-Dressing",ko:"신선한 계절 채소, 방울토마토, 올리브, 발사믹 드레싱"}, price:180, cat:"starters", featured:false, active:true, img:"https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80", images:["https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80"], order:1},
      {id:2, name:{tr:"Mantar Çorbası",en:"Mushroom Soup",ja:"マッシュルームスープ",zh:"蘑菇汤",ru:"Грибной суп",de:"Pilzsuppe",ko:"버섯 수프"}, desc:{tr:"Kremalı orman mantarı çorbası, trüf yağı, kruton",en:"Creamy forest mushroom soup, truffle oil, croutons",ja:"クリーミーな森のキノコスープ、トリュフオイル、クルトン添え",zh:"奶油森林蘑菇汤，松露油，面包丁",ru:"Сливочный суп из лесных грибов, трюфельное масло, крутоны",de:"Cremige Waldpilzsuppe, Trüffelöl, Croutons",ko:"크리미한 숲 버섯 수프, 트러플 오일, 크루통"}, price:145, cat:"starters", featured:false, active:true, img:"https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80", images:["https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80"], order:2},
      {id:3, name:{tr:"Karides Kokteyl",en:"Shrimp Cocktail",ja:"シュリンプカクテル",zh:"虾仁鸡尾酒",ru:"Креветочный коктейль",de:"Shrimps-Cocktail",ko:"쉬림프 칵테일"}, desc:{tr:"İskandinav usulü karides, avokado, limon mayonezi",en:"Scandinavian-style shrimp, avocado, lemon mayonnaise",ja:"北欧風シュリンプ、アボカド、レモンマヨネーズ",zh:"北欧风味虾仁，牛油果，柠檬蛋黄酱",ru:"Креветки по-скандинавски, авокадо, лимонный майонез",de:"Garnelen nach skandinavischer Art, Avocado, Zitronenmayonnaise",ko:"스칸디나비아식 새우, 아보카도, 레몬 마요네즈"}, price:245, cat:"starters", featured:true, active:true, img:"https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&q=80", images:["https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&q=80"], order:3},
      {id:4, name:{tr:"Levrek Fileto",en:"Sea Bass Fillet",ja:"スズキのフィレ",zh:"鲈鱼柳",ru:"Филе сибаса",de:"Wolfsbarschfilet",ko:"농어 필레"}, desc:{tr:"Fırında levrek, limon tereyağı sosu, sebze garnitürü",en:"Oven-baked sea bass, lemon butter sauce, vegetable garnish",ja:"窯焼きスズキ、レモンバターソース、野菜の付け合わせ",zh:"烤箱鲈鱼，柠檬黄油汁，蔬菜配菜",ru:"Сибас в духовке, лимонно-сливочный соус, овощной гарнир",de:"Im Ofen gebackener Wolfsbarsch, Zitronenbuttersauce, Gemüsegarnitur",ko:"오븐에 구운 농어, 레몬 버터 소스, 채소 가니쉬"}, price:520, cat:"mains", featured:true, active:true, img:"https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80", images:["https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80"], order:1},
      {id:5, name:{tr:"Mantarlı Risotto",en:"Mushroom Risotto",ja:"マッシュルームリゾット",zh:"蘑菇烩饭",ru:"Ризотто с грибами",de:"Pilzrisotto",ko:"버섯 리조또"}, desc:{tr:"Arborio pirinci, porcini mantar, parmesan, taze kekik",en:"Arborio rice, porcini mushrooms, parmesan, fresh thyme",ja:"アルボリオ米、ポルチーニ茸、パルメザンチーズ、新鮮なタイム",zh:"阿博里奥米，牛肝菌，帕玛森芝士，新鲜百里香",ru:"Рис арборио, грибы порчини, пармезан, свежий тимьян",de:"Arborio-Reis, Steinpilze, Parmesan, frischer Thymian",ko:"아르보리오 쌀, 포르치니 버섯, 파르메산, 신선한 타임"}, price:380, cat:"mains", featured:false, active:true, img:"https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=600&q=80", images:["https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=600&q=80"], order:2},
      {id:6, name:{tr:"Izgara Bonfile",en:"Grilled Filet Mignon",ja:"グリルフィレミニョン",zh:"烤菲力牛排",ru:"Стейк филе-миньон на гриле",de:"Gegrilltes Filet Mignon",ko:"그릴드 필레미뇽"}, desc:{tr:"250g dana bonfile, mantar sos, patates garnitürü",en:"250g beef filet, mushroom sauce, potato garnish",ja:"250gビーフフィレ、マッシュルームソース、ポテトの付け合わせ",zh:"250克牛菲力，蘑菇汁，土豆配菜",ru:"250г говяжьего филе, грибной соус, картофельный гарнир",de:"250g Rinderfilet, Pilzsauce, Kartoffelgarnitur",ko:"소고기 안심 250g, 버섯 소스, 감자 가니쉬"}, price:680, cat:"grills", featured:true, active:true, img:"https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80", images:["https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80"], order:1},
      {id:7, name:{tr:"Kuzu Pirzola",en:"Lamb Chops",ja:"ラムチョップ",zh:"羊排",ru:"Бараньи отбивные",de:"Lammkoteletts",ko:"양 갈비"}, desc:{tr:"Frenk üzümü sosu, ızgara sebze, nane jölesi",en:"Redcurrant sauce, grilled vegetables, mint jelly",ja:"レッドカラントソース、グリル野菜、ミントジェリー",zh:"红醋栗汁，烤蔬菜，薄荷果冻",ru:"Соус из красной смородины, овощи на гриле, мятное желе",de:"Johannisbeersauce, gegrilltes Gemüse, Minzgelee",ko:"레드커런트 소스, 구운 채소, 민트 젤리"}, price:590, cat:"grills", featured:false, active:true, img:"https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80", images:["https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80"], order:2},
      {id:8, name:{tr:"Tavuk Şiş",en:"Chicken Skewers",ja:"チキンスキュワー",zh:"鸡肉串",ru:"Куриные шашлычки",de:"Hähnchenspieße",ko:"치킨 스큐어"}, desc:{tr:"Marine edilmiş tavuk, közlenmiş biber, pilav, cacık",en:"Marinated chicken, charred peppers, rice, yogurt sauce",ja:"マリネしたチキン、焼きピーマン、ライス、ヨーグルトソース",zh:"腌制鸡肉，烤辣椒，米饭，酸奶酱",ru:"Маринованная курица, печёный перец, рис, соус из йогурта",de:"Mariniertes Hähnchen, gegrillte Paprika, Reis, Joghurtsauce",ko:"양념한 닭고기, 구운 피망, 밥, 요거트 소스"}, price:320, cat:"grills", featured:false, active:true, img:"https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=600&q=80", images:["https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=600&q=80"], order:3},
      {id:9, name:{tr:"Çikolatalı Sufle",en:"Chocolate Soufflé",ja:"チョコレートスフレ",zh:"巧克力舒芙蕾",ru:"Шоколадное суфле",de:"Schokoladensoufflé",ko:"초콜릿 수플레"}, desc:{tr:"Sıcak çikolata sufle, vanilyalı dondurma, çilek",en:"Warm chocolate soufflé, vanilla ice cream, strawberries",ja:"温かいチョコレートスフレ、バニラアイスクリーム、ストロベリー",zh:"热巧克力舒芙蕾，香草冰淇淋，草莓",ru:"Тёплое шоколадное суфле, ванильное мороженое, клубника",de:"Warmes Schokoladensoufflé, Vanilleeis, Erdbeeren",ko:"따뜻한 초콜릿 수플레, 바닐라 아이스크림, 딸기"}, price:165, cat:"desserts", featured:true, active:true, img:"https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80", images:["https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80"], order:1},
      {id:10, name:{tr:"Crème Brûlée",en:"Crème Brûlée",ja:"クレームブリュレ",zh:"焦糖布丁",ru:"Крем-брюле",de:"Crème brûlée",ko:"크렘 브륄레"}, desc:{tr:"Geleneksel Fransız tatlısı, karamelize şeker, mevsim meyvesi",en:"Traditional French dessert, caramelized sugar, seasonal fruit",ja:"伝統的なフランスのデザート、カラメリゼした砂糖、季節のフルーツ",zh:"传统法式甜点，焦糖，季节水果",ru:"Традиционный французский десерт, карамелизированный сахар, сезонные фрукты",de:"Traditionelles französisches Dessert, karamellisierter Zucker, Saisonfrüchte",ko:"전통 프랑스 디저트, 카라멜라이즈드 슈가, 계절 과일"}, price:145, cat:"desserts", featured:false, active:true, img:"https://images.unsplash.com/photo-1470324161839-ce2bb6fa6bc3?w=600&q=80", images:["https://images.unsplash.com/photo-1470324161839-ce2bb6fa6bc3?w=600&q=80"], order:2},
      {id:11, name:{tr:"Limonata",en:"Lemonade",ja:"レモネード",zh:"柠檬水",ru:"Лимонад",de:"Limonade",ko:"레모네이드"}, desc:{tr:"Taze sıkılmış limon, nane, şurup — soğuk veya soda ile",en:"Freshly squeezed lemon, mint, syrup — chilled or with soda",ja:"フレッシュレモン、ミント、シロップ — 冷やしてまたはソーダ入り",zh:"新鲜柠檬汁，薄荷，糖浆 — 冰镇或苏打水",ru:"Свежевыжатый лимон, мята, сироп — холодный или с содовой",de:"Frisch gepresste Zitrone, Minze, Sirup — gekühlt oder mit Soda",ko:"신선한 레몬즙, 민트, 시럽 — 차갑게 또는 소다와 함께"}, price:75, cat:"drinks", featured:false, active:true, img:"https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&q=80", images:["https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&q=80"], order:1},
      {id:12, name:{tr:"Türk Kahvesi",en:"Turkish Coffee",ja:"トルココーヒー",zh:"土耳其咖啡",ru:"Турецкий кофе",de:"Türkischer Kaffee",ko:"터키식 커피"}, desc:{tr:"Geleneksel pişirme, lokum ikramı ile",en:"Traditionally brewed, served with Turkish delight",ja:"伝統的な製法、ロクム(トルコの菓子)付き",zh:"传统煮法，配土耳其软糖",ru:"Традиционное приготовление, подаётся с рахат-лукумом",de:"Traditionell gebrüht, serviert mit türkischem Honig",ko:"전통적인 방식으로 끓인, 터키시 딜라이트와 함께 제공"}, price:65, cat:"drinks", featured:false, active:true, img:"https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=600&q=80", images:["https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=600&q=80"], order:2}
    ],
    gallery: [
      {id:1, img:"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80",  alt:{tr:"Restoran iç mekan",en:"Restaurant interior",ja:"レストラン内装",zh:"餐厅内部",ru:"Интерьер ресторана",de:"Restaurant-Interieur",ko:"레스토랑 내부"}, cls:"tall", active:true, order:1},
      {id:2, img:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80",  alt:{tr:"Özel tabak sunumu",en:"Special dish presentation",ja:"特別な料理の盛り付け",zh:"特色菜品摆盘",ru:"Подача особого блюда",de:"Besondere Tellerpräsentation",ko:"특별 요리 플레이팅"}, cls:"", active:true, order:2},
      {id:3, img:"https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?w=600&q=80",  alt:{tr:"Şef mutfakta",en:"Chef in kitchen",ja:"厨房のシェフ",zh:"厨师在厨房",ru:"Шеф-повар на кухне",de:"Küchenchef in der Küche",ko:"주방의 셰프"}, cls:"", active:true, order:3},
      {id:4, img:"https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1000&q=80",   alt:{tr:"Akşam yemeği ortamı",en:"Dinner ambiance",ja:"夕食の雰囲気",zh:"晚餐氛围",ru:"Атмосфера ужина",de:"Abendessen-Ambiente",ko:"저녁 식사 분위기"}, cls:"wide", active:true, order:4},
      {id:5, img:"https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80",     alt:{tr:"Izgara biftek sunumu",en:"Grilled steak presentation",ja:"グリルステーキの盛り付け",zh:"烤牛排展示",ru:"Подача стейка на гриле",de:"Präsentation von gegrilltem Steak",ko:"그릴 스테이크 플레이팅"}, cls:"", active:true, order:5},
      {id:6, img:"https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80",  alt:{tr:"Şarap servisi",en:"Wine service",ja:"ワインサービス",zh:"葡萄酒服务",ru:"Винное обслуживание",de:"Weinservice",ko:"와인 서비스"}, cls:"", active:true, order:6},
      {id:7, img:"https://images.unsplash.com/photo-1486297678162-eb2a19b0a318?w=600&q=80",  alt:{tr:"Tatlı sunumu",en:"Dessert presentation",ja:"デザートの盛り付け",zh:"甜点展示",ru:"Подача десерта",de:"Dessertpräsentation",ko:"디저트 플레이팅"}, cls:"tall", active:true, order:7},
      {id:8, img:"https://images.unsplash.com/photo-1541614101331-1a5a3a194e92?w=600&q=80",  alt:{tr:"Özel yemek odası",en:"Private dining room",ja:"プライベートダイニングルーム",zh:"私人用餐室",ru:"Отдельный зал для ужина",de:"Privates Speisezimmer",ko:"프라이빗 다이닝룸"}, cls:"", active:true, order:8},
      {id:9, img:"https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=600&q=80",  alt:{tr:"Restoran girişi",en:"Restaurant entrance",ja:"レストランの入り口",zh:"餐厅入口",ru:"Вход в ресторан",de:"Restauranteingang",ko:"레스토랑 입구"}, cls:"", active:true, order:9}
    ],
    reservations: [],
    testimonials: [
...
async function handleAPI(req, res, pathname) {
  ...
  if (resource === 'translate' && method === 'POST') {
    ...
    const result = {};
    (targetLangs || ['en','ja','zh','ru','de','ko']).forEach(lang => {
